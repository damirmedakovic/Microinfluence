        ...
        <div className="w-full md:w-1/2 flex flex-col">
          <div className="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
            ...
            <p className="text-center font-medium text-small">
              Vi håper at vi kan gjøre det enklere for deg å leve av din kreativitet. Fyll ut feltene nedenfor for å komme i gang. 
            </p>
            <form
            ...
            <div className="text-center pt-3 pb-10">
              <p>
                Ikke en innholdsprodusent?{" "}
                <a href="/register-company" className="underline font-semibold">
